    ...
    <section class="badge-progress-card">
      ...
      <div class="badge-row">
        <div class="badge current">
          ...
          <strong style="position: absolute; translate: 200px 0px;">${currentBadge.name}</strong>
        ...
        <div class="badge next">
          ...
          <strong style="position: absolute; translate: 200px 0px;">${nextBadge ? nextBadge.name : "Tous obtenus"}</strong>
          <small>${nextBadge ? `${nextBadge.goal} espèces` : "Photodex complété"}</small>
          <img src="./${nextBadge.image}" alt="${nextBadge.name}" style="position: absolute; height: 100px; width: 100px; translate: 400px -60px; filter: grayscale(90%);">
        </div>
      </div>
